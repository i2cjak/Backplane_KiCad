...
ErcErrorType ToProtoEnum( ERCE_T aValue )
{
    switch( aValue )
    {
    case ERCE_DUPLICATE_SHEET_NAME:     return ERCET_DUPLICATE_SHEET_NAME;
    case ERCE_ENDPOINT_OFF_GRID:        return ERCET_ENDPOINT_OFF_GRID;
    case ERCE_PIN_NOT_CONNECTED:        return ERCET_PIN_NOT_CONNECTED;
    case ERCE_PIN_NOT_DRIVEN:           return ERCET_PIN_NOT_DRIVEN;
    case ERCE_POWERPIN_NOT_DRIVEN:      return ERCET_POWERPIN_NOT_DRIVEN;
    case ERCE_HIERACHICAL_LABEL:        return ERCET_HIERARCHICAL_LABEL;
    case ERCE_NOCONNECT_CONNECTED:      return ERCET_NOCONNECT_CONNECTED;
    case ERCE_NOCONNECT_NOT_CONNECTED:  return ERCET_NOCONNECT_NOT_CONNECTED;
    case ERCE_LABEL_NOT_CONNECTED:      return ERCET_LABEL_NOT_CONNECTED;
    case ERCE_SIMILAR_LABELS:           return ERCET_SIMILAR_LABELS;
    case ERCE_SIMILAR_POWER:            return ERCET_SIMILAR_POWER;
    case ERCE_SIMILAR_LABEL_AND_POWER:  return ERCET_SIMILAR_LABEL_AND_POWER;
    case ERCE_SINGLE_GLOBAL_LABEL:      return ERCET_SINGLE_GLOBAL_LABEL;
    case ERCE_SAME_LOCAL_GLOBAL_LABEL:  return ERCET_SAME_LOCAL_GLOBAL_LABEL;
    case ERCE_DIFFERENT_UNIT_FP:        return ERCET_DIFFERENT_UNIT_FP;
    case ERCE_MISSING_POWER_INPUT_PIN:  return ERCET_MISSING_POWER_INPUT_PIN;
    case ERCE_MISSING_INPUT_PIN:        return ERCET_MISSING_INPUT_PIN;
    case ERCE_MISSING_BIDI_PIN:         return ERCET_MISSING_BIDI_PIN;
    case ERCE_MISSING_UNIT:             return ERCET_MISSING_UNIT;
    case ERCE_DIFFERENT_UNIT_NET:       return ERCET_DIFFERENT_UNIT_NET;
    case ERCE_BUS_ALIAS_CONFLICT:       return ERCET_BUS_ALIAS_CONFLICT;
    case ERCE_DRIVER_CONFLICT:          return ERCET_DRIVER_CONFLICT;
    case ERCE_BUS_ENTRY_CONFLICT:       return ERCET_BUS_ENTRY_CONFLICT;
    case ERCE_BUS_TO_BUS_CONFLICT:      return ERCET_BUS_TO_BUS_CONFLICT;
    case ERCE_BUS_TO_NET_CONFLICT:      return ERCET_BUS_TO_NET_CONFLICT;
    case ERCE_GROUND_PIN_NOT_GROUND:    return ERCET_GROUND_PIN_NOT_GROUND;
    case ERCE_LABEL_SINGLE_PIN:         return ERCET_LABEL_SINGLE_PIN;
    case ERCE_UNRESOLVED_VARIABLE:      return ERCET_UNRESOLVED_VARIABLE;
    case ERCE_UNDEFINED_NETCLASS:       return ERCET_UNDEFINED_NETCLASS;
    case ERCE_SIMULATION_MODEL:         return ERCET_SIMULATION_MODEL;
    case ERCE_WIRE_DANGLING:            return ERCET_WIRE_DANGLING;
    case ERCE_LIB_SYMBOL_ISSUES:        return ERCET_LIB_SYMBOL_ISSUES;
    case ERCE_LIB_SYMBOL_MISMATCH:      return ERCET_LIB_SYMBOL_MISMATCH;
    case ERCE_FOOTPRINT_LINK_ISSUES:    return ERCET_FOOTPRINT_LINK_ISSUES;
    case ERCE_FOOTPRINT_FILTERS:        return ERCET_FOOTPRINT_FILTERS;
    case ERCE_UNANNOTATED:              return ERCET_UNANNOTATED;
    case ERCE_EXTRA_UNITS:              return ERCET_EXTRA_UNITS;
    case ERCE_DIFFERENT_UNIT_VALUE:     return ERCET_DIFFERENT_UNIT_VALUE;
    case ERCE_DUPLICATE_REFERENCE:      return ERCET_DUPLICATE_REFERENCE;
    case ERCE_BUS_ENTRY_NEEDED:         return ERCET_BUS_ENTRY_NEEDED;
    case ERCE_FOUR_WAY_JUNCTION:        return ERCET_FOUR_WAY_JUNCTION;
    case ERCE_LABEL_MULTIPLE_WIRES:     return ERCET_LABEL_MULTIPLE_WIRES;
    case ERCE_UNCONNECTED_WIRE_ENDPOINT:return ERCET_UNCONNECTED_WIRE_ENDPOINT;
    case ERCE_STACKED_PIN_SYNTAX:       return ERCET_STACKED_PIN_SYNTAX;
    case ERCE_DUPLICATE_PIN_ERROR:      return ERCET_DUPLICATE_PIN_ERROR;
    case ERCE_PIN_TO_PIN_WARNING:       return ERCET_PIN_TO_PIN_WARNING;
    case ERCE_PIN_TO_PIN_ERROR:         return ERCET_PIN_TO_PIN_ERROR;
    case ERCE_ANNOTATION_ACTION:        return ERCET_ANNOTATION_ACTION;
    case ERCE_GENERIC_WARNING:          return ERCET_GENERIC_WARNING;
    case ERCE_GENERIC_ERROR:            return ERCET_GENERIC_ERROR;
    case ERCE_FIELD_NAME_WHITESPACE:    return ERCET_FIELD_NAME_WHITESPACE;
    case ERCE_UNSPECIFIED:
    default:                            return ERCET_UNKNOWN;
    }
}
...
ERCE_T FromProtoEnum( ErcErrorType aValue )
{
    switch( aValue )
    {
    case ERCET_DUPLICATE_SHEET_NAME:      return ERCE_DUPLICATE_SHEET_NAME;
    case ERCET_ENDPOINT_OFF_GRID:         return ERCE_ENDPOINT_OFF_GRID;
    case ERCET_PIN_NOT_CONNECTED:         return ERCE_PIN_NOT_CONNECTED;
    case ERCET_PIN_NOT_DRIVEN:            return ERCE_PIN_NOT_DRIVEN;
    case ERCET_POWERPIN_NOT_DRIVEN:       return ERCE_POWERPIN_NOT_DRIVEN;
    case ERCET_HIERARCHICAL_LABEL:        return ERCE_HIERACHICAL_LABEL;
    case ERCET_NOCONNECT_CONNECTED:       return ERCE_NOCONNECT_CONNECTED;
    case ERCET_NOCONNECT_NOT_CONNECTED:   return ERCE_NOCONNECT_NOT_CONNECTED;
    case ERCET_LABEL_NOT_CONNECTED:       return ERCE_LABEL_NOT_CONNECTED;
    case ERCET_SIMILAR_LABELS:            return ERCE_SIMILAR_LABELS;
    case ERCET_SIMILAR_POWER:             return ERCE_SIMILAR_POWER;
    case ERCET_SIMILAR_LABEL_AND_POWER:   return ERCE_SIMILAR_LABEL_AND_POWER;
    case ERCET_SINGLE_GLOBAL_LABEL:       return ERCE_SINGLE_GLOBAL_LABEL;
    case ERCET_SAME_LOCAL_GLOBAL_LABEL:   return ERCE_SAME_LOCAL_GLOBAL_LABEL;
    case ERCET_DIFFERENT_UNIT_FP:         return ERCE_DIFFERENT_UNIT_FP;
    case ERCET_MISSING_POWER_INPUT_PIN:   return ERCE_MISSING_POWER_INPUT_PIN;
    case ERCET_MISSING_INPUT_PIN:         return ERCE_MISSING_INPUT_PIN;
    case ERCET_MISSING_BIDI_PIN:          return ERCE_MISSING_BIDI_PIN;
    case ERCET_MISSING_UNIT:              return ERCE_MISSING_UNIT;
    case ERCET_DIFFERENT_UNIT_NET:        return ERCE_DIFFERENT_UNIT_NET;
    case ERCET_BUS_ALIAS_CONFLICT:        return ERCE_BUS_ALIAS_CONFLICT;
    case ERCET_DRIVER_CONFLICT:           return ERCE_DRIVER_CONFLICT;
    case ERCET_BUS_ENTRY_CONFLICT:        return ERCE_BUS_ENTRY_CONFLICT;
    case ERCET_BUS_TO_BUS_CONFLICT:       return ERCE_BUS_TO_BUS_CONFLICT;
    case ERCET_BUS_TO_NET_CONFLICT:       return ERCE_BUS_TO_NET_CONFLICT;
    case ERCET_GROUND_PIN_NOT_GROUND:     return ERCE_GROUND_PIN_NOT_GROUND;
    case ERCET_LABEL_SINGLE_PIN:          return ERCE_LABEL_SINGLE_PIN;
    case ERCET_UNRESOLVED_VARIABLE:       return ERCE_UNRESOLVED_VARIABLE;
    case ERCET_UNDEFINED_NETCLASS:        return ERCE_UNDEFINED_NETCLASS;
    case ERCET_SIMULATION_MODEL:          return ERCE_SIMULATION_MODEL;
    case ERCET_WIRE_DANGLING:             return ERCE_WIRE_DANGLING;
    case ERCET_LIB_SYMBOL_ISSUES:         return ERCE_LIB_SYMBOL_ISSUES;
    case ERCET_LIB_SYMBOL_MISMATCH:       return ERCE_LIB_SYMBOL_MISMATCH;
    case ERCET_FOOTPRINT_LINK_ISSUES:     return ERCE_FOOTPRINT_LINK_ISSUES;
    case ERCET_FOOTPRINT_FILTERS:         return ERCE_FOOTPRINT_FILTERS;
    case ERCET_UNANNOTATED:               return ERCE_UNANNOTATED;
    case ERCET_EXTRA_UNITS:               return ERCE_EXTRA_UNITS;
    case ERCET_DIFFERENT_UNIT_VALUE:      return ERCE_DIFFERENT_UNIT_VALUE;
    case ERCET_DUPLICATE_REFERENCE:       return ERCE_DUPLICATE_REFERENCE;
    case ERCET_BUS_ENTRY_NEEDED:          return ERCE_BUS_ENTRY_NEEDED;
    case ERCET_FOUR_WAY_JUNCTION:         return ERCE_FOUR_WAY_JUNCTION;
    case ERCET_LABEL_MULTIPLE_WIRES:      return ERCE_LABEL_MULTIPLE_WIRES;
    case ERCET_UNCONNECTED_WIRE_ENDPOINT: return ERCE_UNCONNECTED_WIRE_ENDPOINT;
    case ERCET_STACKED_PIN_SYNTAX:        return ERCE_STACKED_PIN_SYNTAX;
    case ERCET_DUPLICATE_PIN_ERROR:       return ERCE_DUPLICATE_PIN_ERROR;
    case ERCET_PIN_TO_PIN_WARNING:        return ERCE_PIN_TO_PIN_WARNING;
    case ERCET_PIN_TO_PIN_ERROR:          return ERCE_PIN_TO_PIN_ERROR;
    case ERCET_ANNOTATION_ACTION:         return ERCE_ANNOTATION_ACTION;
    case ERCET_GENERIC_WARNING:           return ERCE_GENERIC_WARNING;
    case ERCET_GENERIC_ERROR:             return ERCE_GENERIC_ERROR;
    case ERCET_FIELD_NAME_WHITESPACE:     return ERCE_FIELD_NAME_WHITESPACE;
    default:                                     return ERCE_UNSPECIFIED;
    }
}
