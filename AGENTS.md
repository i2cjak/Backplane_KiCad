...
- Do not raise native file-format versions or emit newer unsupported tokens. Store fork-only metadata in adjacent `.backplane.json` companions, and preserve those companions through save/copy/export staging.
